          ...
          <TransitionChild as="template" enter="ease-out duration-300"
            ...
            <DialogPanel
              ...
              <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                <button type="button"
                  class="inline-flex w-full justify-center rounded-md negativeBackground px-6 py-3 text-sm  text-white shadow-sm   sm:ml-3 sm:w-auto"
                  @click="resetCache()">
                  Confirm
                </button>
                <button type="button"
                  ...
                  ref="cancelButtonRef" @click="
                    $store.commit('cMaster/setresetdialogue', false);
                  open = false;
                  ">
                  Cancel
                </button>
...
export default defineComponent({
  ...
  methods: {
    resetCache() {
      ...
      this.$store.commit('cMaster/setresetdialogue', false);
      this.open = false;
  ...
  computed: {
    ...mapState("cMaster", ["setresetdialogue"]),
