              ...
              <div class="text-center">
                ...
                <div class="mt-2">
                  <p class="text-sm text-gray-500">
                    Are you sure want to Unblock {{ cData.ucc }}?
                  </p>
                </div>
              </div>
            </div>
...
export default defineComponent({
  ...
  props: {
    cData: { type: Object as PropType<any>},
  },
  methods: {
    handleCancel() {
      this.$store.commit("user/setAuthorizeUnblockDialog", false);
    },
    async handleSubmit() {
      await this.$store.dispatch("user/unblockUser", this.cData.ucc);
      this.handleCancel();
    },
  },
});
